package com.csotirio.cryptotracker.ui.coin_details.composable
...
import com.csotirio.cryptotracker.ui.coin_details.ChartStyle
import com.csotirio.cryptotracker.ui.coin_details.DataPoint
import com.csotirio.cryptotracker.ui.coin_details.LineChart
import com.csotirio.cryptotracker.ui.coin_details.composable.components.InfoCard
        ...
        Column(
            ...
            FlowRow(
                ...
                val absoluteChangeFormatted =
                    ((coin.priceUsd?.value ?: 0.0) * ((coin.changePercent24Hr?.value
                        ?: 0.0) / 100)).toDisplayableNumberUiModel()
                val isPositive = (coin.changePercent24Hr?.value ?: 0.0) > 0.0
...
private fun CoinDetailScreenPreview() {
    CryptoTrackerTheme {
        CoinDetailScreen(
            state = CoinListUiModel(
                selectedCoin = previewCoinUiModel,
            ),
